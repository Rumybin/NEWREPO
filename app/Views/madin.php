          ...
          <div class="col-12 col-md-6">
            <div class="card bg-transparent mb-5" data-aos="zoom-in-up">
              <div class="bg-green shadow rounded-5 p-0">
                <img src="<?= base_url('images/ekstra/' . $ekstra['gambar']); ?>" width="685" height="442" alt="<?= $ekstra['nama']; ?>" class="img-fluid rounded-5 no-bottom-radius" loading="lazy">
                <div class="p-5">
                  <h2 class="fw-lighter"><?= esc($ekstra['nama']); ?></h2>
                  <p class="pb-4 text-white text-secondary"><?= esc($ekstra['des']); ?></p>
                  <a href="<?= base_url('/halaman/' . $ekstra['nama']); ?>" class="link-fancy link-fancy-light">Read more</a>
                </div>
              </div>
            </div>
          </div>
