...
<head>
  ...
  <style>
    ...
    @font-face {
      ...
      font-display: swap;
      src: local(''),
        url('<?= base_url('fonts/inter-v12-latin-300.woff2'); ?>') format('woff2'),
        url('<?= base_url('fonts/inter-v12-latin-300.woff'); ?>') format('woff');
    }
    ...
    @font-face {
      ...
      font-display: swap;
      src: local(''),
        url('<?= base_url('fonts/inter-v12-latin-regular.woff2'); ?>') format('woff2'),
        url('<?= base_url('fonts/inter-v12-latin-regular.woff'); ?>') format('woff');
    }
    ...
    @font-face {
      ...
      font-display: swap;
      src: local(''),
        url('<?= base_url('fonts/inter-v12-latin-500.woff2'); ?>') format('woff2'),
        url('<?= base_url('fonts/inter-v12-latin-500.woff'); ?>') format('woff');
    }
    ...
    @font-face {
      ...
      font-display: swap;
      src: local(''),
        url('<?= base_url('fonts/inter-v12-latin-700.woff2'); ?>') format('woff2'),
        url('<?= base_url('fonts/inter-v12-latin-700.woff'); ?>') format('woff');
    }
  </style>
</head>
  ...
  <div class="bg-white py-vh-3">
    <div class="container bg-white px-vw-5 py-vh-3 ">
      <div class="row gx-5 pt-semi">
        <?php foreach ($ekstra_nonolim as $ekstra) : ?>
